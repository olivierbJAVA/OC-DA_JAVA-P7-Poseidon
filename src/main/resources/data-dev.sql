insert into Users(fullname, username, password, role) values('Administrator', 'admin', '$2a$10$yItPXT0kaTk/7gY6yAA7keljOdmQvXwg9.pZNSfOqq5zocpt2z36G', 'ADMIN');
insert into Users(fullname, username, password, role) values('User', 'user', '$2a$10$qKBKRgXL2fS63N5pvFlL.O5uSzV2A/9EPD.EwGz3M0BfxcF18dBEm', 'USER');
